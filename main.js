...
function move(){
    if(page == '1'){
        ...
        document.getElementById('message').innerText = 'Haii Amelia, Ada sesuatu nih buat kamu tapi maaf yaa kalo kurang bagus, Dan semoga kamu suka yaa, Selamat membaca...'
